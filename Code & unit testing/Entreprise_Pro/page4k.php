...
<head>                                                             <!-- Line 3:  Opens the head section -->
    ...
    <title>Marshfield School History â Admission Register – Junior Aug 1928–Jan 1944</title>             <!-- Line 6:  Browser tab title -->
...
<main>                                                             <!-- Line 99: Opens main content -->
    ...
    <h2 class="page-heading">Admission Register – Junior Aug 1928–Jan 1944</h2>                         <!-- Line 106: Page heading showing document name -->
    ...
    <object class="pdf-container"                                  <!-- Line 114: Opens the PDF viewer element -->
            data="Images/Admission_Registers/Junior_Aug1928-Jan1944.pdf"                                           <!-- Line 115: Points to the PDF file location -->
        ...
        <div class="pdf-fallback">                                 <!-- Line 117: Opens fallback message (shown if PDF viewer fails) -->
            ...
            <p><a href="Images/Admission_Registers/Junior_Aug1928-Jan1944.pdf">Click here to download and open the document</a></p> <!-- Line 119: Direct download link -->
