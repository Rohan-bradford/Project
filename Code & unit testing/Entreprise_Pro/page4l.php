...
<head>                                                             <!-- Line 3:  Opens the head section -->
    ...
    <title>Marshfield School History â Admission Register – Junior Mar 1944–Feb 1954</title>             <!-- Line 6:  Browser tab title -->
...
<main>                                                             <!-- Line 99: Opens main content -->
    ...
    <div class="back-bar">                                         <!-- Line 102: Opens back button row -->
        <a href="page4.php" class="btn-back">&#8592; Back to Marshfield School</a> <!-- Line 103: Back button link -->
    </div>                                                         <!-- Line 104: Closes back button row -->

    <h2 class="page-heading">Admission Register – Junior Mar 1944–Feb 1954</h2>                         <!-- Line 106: Page heading showing document name -->
    ...
    <object class="pdf-container"                                  <!-- Line 114: Opens the PDF viewer element -->
            data="Images/Admission_Registers/Junior_Mar1944-Feb1954.pdf"                                           <!-- Line 115: Points to the PDF file location -->
        ...
        <div class="pdf-fallback">                                 <!-- Line 117: Opens fallback message (shown if PDF viewer fails) -->
            ...
            <p><a href="Images/Admission_Registers/Junior_Mar1944-Feb1954.pdf">Click here to download and open the document</a></p> <!-- Line 119: Direct download link -->
