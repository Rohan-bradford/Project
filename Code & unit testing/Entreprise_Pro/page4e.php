...
<head>                                                             <!-- Line 3:  Opens the head section -->
    ...
    <title>Marshfield School History â Logbook (Junior) 1933–1964</title>             <!-- Line 6:  Browser tab title -->
...
<main>                                                             <!-- Line 99: Opens main content -->
    ...
    <h2 class="page-heading">Logbook (Junior) 1933–1964</h2>                         <!-- Line 106: Page heading showing document name -->
    ...
    <object class="pdf-container"                                  <!-- Line 114: Opens the PDF viewer element -->
            data="Images/Logbooks/Junior_1933-1964.pdf"                                           <!-- Line 115: Points to the PDF file location -->
        ...
        <div class="pdf-fallback">                                 <!-- Line 117: Opens fallback message (shown if PDF viewer fails) -->
            ...
            <p><a href="Images/Logbooks/Junior_1933-1964.pdf">Click here to download and open the document</a></p> <!-- Line 119: Direct download link -->
